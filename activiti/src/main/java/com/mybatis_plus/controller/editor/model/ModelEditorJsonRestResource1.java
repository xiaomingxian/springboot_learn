 ...
 */
package com.mybatis_plus.controller.editor.model;
 ...
 */
@Api(value = "跳转在线编辑", description = "跳转在线编辑")
@RestController
@RequestMapping("service")
public class ModelEditorJsonRestResource1 implements ModelDataJsonConstants {
